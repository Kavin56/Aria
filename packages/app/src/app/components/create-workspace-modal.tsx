        ...
        <Show when={showClose()}>
          ...
          <div class={`p-6 flex-1 overflow-y-auto space-y-8 transition-opacity duration-300 ${provisioning() ? "opacity-40 pointer-events-none" : "opacity-100"}`}>
            ...
            <div class="space-y-4">
              ...
              <div class={`ml-9 grid gap-3 ${!effectiveFolder() ? "opacity-50" : ""}`.trim()}>
                <For each={options()}>
                  {(opt) => (
                    <div
                      onClick={() => {
                      ...
                      } ${!effectiveFolder() || submitting() ? "pointer-events-none" : ""}`.trim()}
                    >
        ...
        <div class="flex justify-end gap-3">
          ...
          <Show when={props.onConfirmWorker}>
            <Button
              ...
              title={(() => {
                if (!effectiveFolder()) return translate("dashboard.choose_folder_continue");
