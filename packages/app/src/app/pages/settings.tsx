...
export function OpenCodeRouterSettings(_props: {
  ...
  return (
    <div class="bg-white dark:bg-black border border-gray-200 dark:border-gray-800 rounded-2xl p-5 space-y-2">
      <div class="flex items-center gap-2">
        <MessageCircle size={16} class="text-gray-600 dark:text-gray-400" />
        <div class="text-sm font-medium text-black dark:text-white">Messaging</div>
      </div>
      <div class="text-xs text-gray-600 dark:text-gray-400">
        Manage Telegram/Slack identities and bindings in the <span class="font-medium text-black dark:text-white">Identities</span> tab.
      </div>
    </div>
  );
}
...
export default function SettingsView(props: SettingsViewProps) {
  ...
  const updateToolbarTone = createMemo(() => {
    switch (updateState()) {
      ...
      case "checking":
      case "downloading":
        return "bg-gray-100 dark:bg-gray-800/60 text-gray-600 dark:text-gray-400 border-gray-200 dark:border-gray-800";
      default:
        return "bg-gray-100 dark:bg-gray-800/60 text-gray-600 dark:text-gray-400 border-gray-200 dark:border-gray-800";
    }
  });
  ...
  const providerStatusStyle = createMemo(() => {
    if (!providerAvailableCount()) return "bg-gray-100 dark:bg-gray-800/60 text-gray-600 dark:text-gray-400 border-gray-200 dark:border-gray-800";
  ...
  const engineStatusStyle = createMemo(() => {
    if (!isTauriRuntime()) return "bg-gray-100 dark:bg-gray-800/60 text-gray-600 dark:text-gray-400 border-gray-200 dark:border-gray-800";
    return props.engineInfo?.running
      ? "bg-green-7/10 text-green-11 border-green-7/20"
      : "bg-gray-100 dark:bg-gray-800/60 text-gray-600 dark:text-gray-400 border-gray-200 dark:border-gray-800";
  });
  ...
  const opencodeConnectStatusStyle = createMemo(() => {
    const status = props.opencodeConnectStatus?.status;
    if (!status) return "bg-gray-100 dark:bg-gray-800/60 text-gray-600 dark:text-gray-400 border-gray-200 dark:border-gray-800";
  ...
  const orchestratorStatusStyle = createMemo(() => {
    if (!props.orchestratorStatus) return "bg-gray-100 dark:bg-gray-800/60 text-gray-600 dark:text-gray-400 border-gray-200 dark:border-gray-800";
  ...
  const openworkAuditStatusStyle = createMemo(() => {
    if (!props.openworkServerWorkspaceId) return "bg-gray-100 dark:bg-gray-800/60 text-gray-600 dark:text-gray-400 border-gray-200 dark:border-gray-800";
  ...
  const compactOutlineActionClass =
    "inline-flex items-center gap-1.5 rounded-md border border-gray-200 dark:border-gray-800 bg-white dark:bg-black px-3 py-1.5 text-xs font-medium text-gray-600 dark:text-gray-400 shadow-sm transition-colors duration-150 hover:bg-gray-50 dark:hover:bg-gray-900 hover:text-black dark:hover:text-white focus:outline-none focus-visible:ring-2 focus-visible:ring-[rgba(var(--dls-accent-rgb),0.25)] disabled:cursor-not-allowed disabled:opacity-60";
  ...
  return (
    <section class="space-y-6">
      <div class="flex flex-col gap-3 md:flex-row md:items-center md:justify-between rounded-2xl border border-gray-200 dark:border-gray-800/40 bg-white dark:bg-black/40 px-3 py-2">
              ...
              <button
                class={`px-3 py-2 rounded-xl text-xs font-medium border transition-colors ${
                  activeTab() === tab
                    ...
                    : "text-gray-600 dark:text-gray-400 border-gray-200 dark:border-gray-800 hover:text-black dark:text-white hover:bg-gray-50 dark:bg-gray-900"
                }`}
        ...
        <Show when={showUpdateToolbar()}>
          <div class="flex flex-wrap items-center gap-2">
            ...
            <Show when={updateToolbarActionLabel()}>
              <Button
                variant="outline"
                class="text-xs h-8 py-0 px-3 rounded-full border-gray-200 dark:border-gray-800 bg-white dark:bg-black/70 hover:bg-gray-50 dark:bg-gray-900/70"
      ...
      <Switch>
          ...
          <div class="space-y-6">
            <div class="bg-white dark:bg-black border border-gray-200 dark:border-gray-800 rounded-2xl p-5 space-y-4">
              <div class="flex items-start justify-between gap-4">
                <div>
                  <div class="flex items-center gap-2">
                    <PlugZap size={16} class="text-gray-600 dark:text-gray-400" />
                    <div class="text-sm font-medium text-black dark:text-white">Providers</div>
                  </div>
                  <div class="text-xs text-gray-600 dark:text-gray-400 mt-1">Connect services for models and tools.</div>
                </div>
              ...
              <div class="flex flex-wrap items-center gap-3">
                ...
                <div class="text-xs text-gray-600 dark:text-gray-400">{providerSummary()}</div>
              </div>
              ...
              <Show when={connectedProviders().length > 0}>
                <div class="space-y-2">
                  <For each={connectedProviders()}>
                    {(provider) => (
                      <div class="flex flex-wrap items-center justify-between gap-3 rounded-xl border border-gray-200 dark:border-gray-800 bg-white dark:bg-black/40 px-3 py-2">
                        <div class="min-w-0">
                          <div class="text-sm font-medium text-black dark:text-white truncate">{provider.name}</div>
                          <div class="text-[11px] text-gray-500 dark:text-gray-500 font-mono truncate">{provider.id}</div>
                        </div>
                        <Button
                          variant="outline"
              ...
              <Show when={providerDisconnectStatus()}>
                <div class="rounded-xl border border-gray-200 dark:border-gray-800 bg-white dark:bg-black/40 px-3 py-2 text-xs text-gray-600 dark:text-gray-400">
            ...
            <div class="bg-white dark:bg-black border border-gray-200 dark:border-gray-800 rounded-2xl p-5 space-y-4">
              <div>
                <div class="text-sm font-medium text-black dark:text-white">Appearance</div>
                <div class="text-xs text-gray-600 dark:text-gray-400">Match the system or force light/dark mode.</div>
              </div>
              ...
              <div class="space-y-2">
                <div class="text-xs font-medium text-gray-600 dark:text-gray-400">{translate("settings.language")}</div>
                <div class="text-xs text-gray-600 dark:text-gray-400">{translate("settings.language.description")}</div>
                <div class="flex flex-wrap gap-2">
        ...
        <Match when={activeTab() === "model"}>
          <div class="space-y-6">
            <div class="bg-white dark:bg-black border border-gray-200 dark:border-gray-800 rounded-2xl p-5 space-y-4">
              <div>
                <div class="text-sm font-medium text-black dark:text-white">Model</div>
                <div class="text-xs text-gray-600 dark:text-gray-400">Defaults + thinking controls for runs.</div>
              </div>

              <div class="flex items-center justify-between bg-white dark:bg-black p-3 rounded-xl border border-gray-200 dark:border-gray-800 gap-3">
                <div class="min-w-0">
                  <div class="text-sm text-black dark:text-white truncate">{props.defaultModelLabel}</div>
                  <div class="text-xs text-gray-500 dark:text-gray-500 font-mono truncate">{props.defaultModelRef}</div>
                </div>
                <Button
                  variant="outline"
              ...
              <div class="flex items-center justify-between bg-white dark:bg-black p-3 rounded-xl border border-gray-200 dark:border-gray-800 gap-3">
                <div class="min-w-0">
                  <div class="text-sm text-black dark:text-white">Thinking</div>
                  <div class="text-xs text-gray-500 dark:text-gray-500">Show thinking parts (Developer mode only).</div>
                </div>
                <Button
                  variant="outline"
                  class="text-xs h-8 py-0 px-3 shrink-0"
              ...
              <div class="flex items-center justify-between bg-white dark:bg-black p-3 rounded-xl border border-gray-200 dark:border-gray-800 gap-3">
                <div class="min-w-0">
                  <div class="text-sm text-black dark:text-white">Auto context compaction</div>
                  <div class="text-xs text-gray-500 dark:text-gray-500">Automatically compact after a run completes.</div>
                </div>
                <Button
                  variant="outline"
                  class="text-xs h-8 py-0 px-3 shrink-0"
              ...
              <div class="flex items-center justify-between bg-white dark:bg-black p-3 rounded-xl border border-gray-200 dark:border-gray-800 gap-3">
                <div class="min-w-0">
                  <div class="text-sm text-black dark:text-white">Model variant</div>
                  <div class="text-xs text-gray-500 dark:text-gray-500 font-mono truncate">{props.modelVariantLabel}</div>
                </div>
                <Button
                  variant="outline"
                  class="text-xs h-8 py-0 px-3 shrink-0"
        ...
        <Match when={activeTab() === "advanced"}>
          <div class="space-y-6">
            <div class="bg-white dark:bg-black border border-gray-200 dark:border-gray-800 rounded-2xl p-5 space-y-3">
              <div class="text-sm font-medium text-black dark:text-white">Developer mode</div>
              <div class="text-xs text-gray-600 dark:text-gray-400">
            ...
            <div class="bg-white dark:bg-black border border-gray-200 dark:border-gray-800 rounded-2xl p-5 space-y-3">
              ...
              <Show when={openworkReconnectStatus()}>
                {(value) => <div class="text-xs text-gray-600 dark:text-gray-400">{value()}</div>}
              </Show>
            ...
            <div class="bg-white dark:bg-black border border-gray-200 dark:border-gray-800 rounded-2xl p-5 space-y-4">
              <div>
                <div class="text-sm font-medium text-black dark:text-white">{translate("settings.migration_recovery_label")}</div>
                <div class="text-xs text-gray-600 dark:text-gray-400">{translate("settings.migration_recovery_hint")}</div>
              </div>
              <div class="flex flex-wrap items-center gap-2">
                <Button
                  variant="secondary"
              ...
              <Show when={props.migrationRepairBusy}>
                <div class="text-xs text-gray-600 dark:text-gray-400">{translate("status.repairing_migration")}</div>
              </Show>
            ...
            <div class="bg-white dark:bg-black border border-gray-200 dark:border-gray-800 rounded-2xl p-5 space-y-3">
              <div class="flex items-start justify-between gap-4">
                <div>
                  <div class="text-sm font-medium text-black dark:text-white">Updates</div>
                  <div class="text-xs text-gray-600 dark:text-gray-400">Keep OpenWork up to date.</div>
                </div>
                <div class="text-xs text-gray-500 dark:text-gray-500 font-mono">{props.appVersion ? `v${props.appVersion}` : ""}</div>
              </div>
              ...
              <Show
                ...
                fallback={
                  <Show
                    ...
                    fallback={
                      <>
                        <div class="flex items-center justify-between bg-white dark:bg-black p-3 rounded-xl border border-gray-200 dark:border-gray-800">
                          <div class="space-y-0.5">
                            <div class="text-sm text-black dark:text-white">Background checks</div>
                            <div class="text-xs text-gray-500 dark:text-gray-500">OpenWork always checks on launch. Also checks once per day (quiet).</div>
                          </div>
                          <button
                            class={`min-w-[70px] px-4 py-1.5 rounded-full text-xs font-medium border shadow-[inset_0_1px_0_rgba(255,255,255,0.5)] transition-colors ${
                              props.updateAutoCheck
                                ? "bg-white dark:bg-black2/12 text-black dark:text-white border-gray-200 dark:border-gray-800/30"
                                : "bg-white dark:bg-black/70 text-gray-600 dark:text-gray-400 border-gray-200 dark:border-gray-800 hover:text-black dark:text-white hover:bg-gray-50 dark:bg-gray-900/70"
                            }`}
                        ...
                        <div class="flex items-center justify-between bg-white dark:bg-black p-3 rounded-xl border border-gray-200 dark:border-gray-800">
                          <div class="space-y-0.5">
                            <div class="text-sm text-black dark:text-white">Auto-update</div>
                            <div class="text-xs text-gray-500 dark:text-gray-500">Download updates automatically (prompts to restart)</div>
                          </div>
                          <button
                            class={`min-w-[70px] px-4 py-1.5 rounded-full text-xs font-medium border shadow-[inset_0_1px_0_rgba(255,255,255,0.5)] transition-colors ${
                        ...
                        <div class="flex items-center justify-between gap-3 bg-white dark:bg-black p-3 rounded-xl border border-gray-200 dark:border-gray-800">
                          <div class="space-y-0.5">
                            ...
                            <Show when={updateState() === "available" && updateDate()}>
                              <div class="text-xs text-gray-500 dark:text-gray-500">Published {updateDate()}</div>
                            </Show>
                          ...
                          <div class="flex items-center gap-2">
                            <Button
                              variant="outline"
                              class="text-xs h-9 py-0 px-4 rounded-full border-gray-200 dark:border-gray-800 bg-white dark:bg-black/70 hover:bg-gray-50 dark:bg-gray-900/70"
                        ...
                        <Show when={updateState() === "available" && updateNotes()}>
                          <div class="rounded-xl bg-white dark:bg-black/20 border border-gray-200 dark:border-gray-800 p-3 text-xs text-gray-600 dark:text-gray-400 whitespace-pre-wrap max-h-40 overflow-auto">
                            {updateNotes()}
                          </div>
                        </Show>
                      </>
                  ...
                  >
                    <div class="rounded-xl bg-white dark:bg-black/20 border border-gray-200 dark:border-gray-800 p-3 text-sm text-gray-600 dark:text-gray-400">
            ...
            <Show when={isTauriRuntime()}>
              <div class="bg-white dark:bg-black border border-gray-200 dark:border-gray-800 rounded-2xl p-5 space-y-3">
                <div>
                  <div class="text-sm font-medium text-black dark:text-white">Appearance</div>
                  <div class="text-xs text-gray-600 dark:text-gray-400">Customize window appearance.</div>
                </div>

                <div class="flex items-center justify-between bg-white dark:bg-black p-3 rounded-xl border border-gray-200 dark:border-gray-800 gap-3">
                  <div class="min-w-0">
                    <div class="text-sm text-black dark:text-white">Hide titlebar</div>
                    <div class="text-xs text-gray-500 dark:text-gray-500">
        ...
        <Match when={activeTab() === "debug"}>
          <Show when={props.developerMode}>
            <section>
              <h3 class="text-sm font-medium text-gray-600 dark:text-gray-400 uppercase tracking-wider mb-4">Developer</h3>

              <div class="space-y-4">
                <div class="bg-white dark:bg-black border border-gray-200 dark:border-gray-800 rounded-2xl p-5 space-y-3">
                  <div class="flex items-start justify-between gap-3">
                    <div>
                      <div class="text-sm font-medium text-black dark:text-white">Runtime debug report</div>
                      <div class="text-xs text-gray-600 dark:text-gray-400">Readable diagnostics snapshot with one-click export.</div>
                    </div>
                  ...
                  <div class="grid gap-2 md:grid-cols-2 text-xs text-gray-600 dark:text-gray-400">
                  ...
                  <pre class="text-xs text-black dark:text-white whitespace-pre-wrap break-words max-h-64 overflow-auto bg-white dark:bg-black border border-gray-200 dark:border-gray-800 rounded-lg p-3">
                    {runtimeDebugReportJson()}
                  </pre>
                  <Show when={debugReportStatus()}>
                    {(status) => <div class="text-xs text-gray-600 dark:text-gray-400">{status()}</div>}
                  </Show>
                </div>
                ...
                <div class="bg-white dark:bg-black border border-gray-200 dark:border-gray-800 rounded-2xl p-5 space-y-3">
                  <div class="flex items-start justify-between gap-3">
                    <div>
                      <div class="text-sm font-medium text-black dark:text-white">Sandbox probe</div>
                      <div class="text-xs text-gray-600 dark:text-gray-400">
                ...
                <div class="bg-white dark:bg-black border border-gray-200 dark:border-gray-800 rounded-2xl p-5 space-y-3">
                  <div class="text-sm font-medium text-black dark:text-white">Workspace config</div>
                  <div class="text-xs text-gray-600 dark:text-gray-400">Reveal or reset `.opencode/openwork.json` defaults for this app workspace.</div>
                  <div class="text-[11px] text-gray-500 dark:text-gray-500 font-mono break-all">{workspaceConfigPath() || "No active local workspace."}</div>
                  <div class="flex flex-wrap items-center gap-2">
                    <Button
                      variant="outline"
                      class="text-xs h-8 py-0 px-3"
                ...
                <div class="bg-white dark:bg-black border border-gray-200 dark:border-gray-800 rounded-2xl p-4 flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                  <div class="min-w-0">
                    <div class="text-sm text-black dark:text-white">OpenCode cache</div>
                    <div class="text-xs text-gray-500 dark:text-gray-500">
                      Repairs cached data used to start the engine. Safe to run.
                    </div>
                    <Show when={props.cacheRepairResult}>
                      <div class="text-xs text-gray-600 dark:text-gray-400 mt-2">{props.cacheRepairResult}</div>
                    </Show>
                  </div>
                  <Button
                    variant="secondary"
                ...
                <div class="bg-white dark:bg-black border border-gray-200 dark:border-gray-800 rounded-2xl p-4 flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                  <div class="min-w-0">
                    <div class="text-sm text-black dark:text-white">OpenWork Docker containers</div>
                    <div class="text-xs text-gray-500 dark:text-gray-500">
                      Force-remove Docker containers launched by OpenWork (sandbox + local dev stacks).
                    </div>
                    <Show when={props.dockerCleanupResult}>
                      <div class="text-xs text-gray-600 dark:text-gray-400 mt-2">{props.dockerCleanupResult}</div>
                    </Show>
                  </div>
                  <Button
                    variant="danger"
                ...
                <div class="bg-white dark:bg-black border border-gray-200 dark:border-gray-800 rounded-2xl p-5 space-y-3">
                  <div class="text-sm font-medium text-black dark:text-white">Startup</div>
                  ...
                  <div class="flex items-center justify-between bg-white dark:bg-black p-3 rounded-xl border border-gray-200 dark:border-gray-800">
                    <div class="flex items-center gap-3">
                      ...
                      <span class="text-sm font-medium text-black dark:text-white">{startupLabel()}</span>
                    </div>
                    <Button
                      variant="outline"
                      class="text-xs h-8 py-0 px-3"
                ...
                <Show when={isTauriRuntime() && (isLocalPreference() || props.developerMode)}>
                  <div class="bg-white dark:bg-black border border-gray-200 dark:border-gray-800 rounded-2xl p-5 space-y-4">
                    <div>
                      <div class="text-sm font-medium text-black dark:text-white">Engine</div>
                      <div class="text-xs text-gray-600 dark:text-gray-400">Choose how OpenCode runs locally.</div>
                    </div>
                    ...
                    <div class="space-y-3">
                      <div class="text-xs text-gray-600 dark:text-gray-400">Engine source</div>
                    ...
                    <Show when={props.developerMode && props.engineSource === "custom"}>
                      <div class="space-y-2">
                        <div class="text-xs text-gray-600 dark:text-gray-400">Custom OpenCode binary</div>
                        <div class="flex items-center gap-2">
                          <div
                            class="flex-1 min-w-0 text-[11px] text-gray-500 dark:text-gray-500 font-mono truncate bg-white dark:bg-black p-3 rounded-xl border border-gray-200 dark:border-gray-800"
                    ...
                    <Show when={props.developerMode}>
                      <div class="space-y-3">
                        <div class="text-xs text-gray-600 dark:text-gray-400">Engine runtime</div>
                        ...
                        <div class="text-[11px] text-gray-500 dark:text-gray-500">Applies the next time the engine starts or reloads.</div>
                      </div>
                    </Show>
                  </div>
                </Show>
                ...
                <div class="bg-white dark:bg-black border border-gray-200 dark:border-gray-800 rounded-2xl p-5 space-y-4">
                  <div>
                    <div class="text-sm font-medium text-black dark:text-white">Reset & Recovery</div>
                    <div class="text-xs text-gray-600 dark:text-gray-400">Clear data or restart the setup flow.</div>
                  </div>

                  <div class="flex items-center justify-between bg-white dark:bg-black p-3 rounded-xl border border-gray-200 dark:border-gray-800 gap-3">
                    <div class="min-w-0">
                      <div class="text-sm text-black dark:text-white">Reset onboarding</div>
                      <div class="text-xs text-gray-500 dark:text-gray-500">Clears OpenWork preferences and restarts the app.</div>
                    </div>
                    <Button
                      variant="outline"
                      class="text-xs h-8 py-0 px-3 shrink-0"
                  ...
                  <div class="flex items-center justify-between bg-white dark:bg-black p-3 rounded-xl border border-gray-200 dark:border-gray-800 gap-3">
                    <div class="min-w-0">
                      <div class="text-sm text-black dark:text-white">Reset app data</div>
                      <div class="text-xs text-gray-500 dark:text-gray-500">More aggressive. Clears OpenWork cache + app data.</div>
                    </div>
                    <Button
                      variant="danger"
                      class="text-xs h-8 py-0 px-3 shrink-0"
                  ...
                  <div class="text-xs text-gray-500 dark:text-gray-500">
                    Requires typing <span class="font-mono text-gray-600 dark:text-gray-400">RESET</span> and will restart the app.
                  </div>
                </div>

                <div class="bg-white dark:bg-black border border-gray-200 dark:border-gray-800 rounded-2xl p-5 space-y-4">
                  <div>
                    <div class="text-sm font-medium text-black dark:text-white">Devtools</div>
                    <div class="text-xs text-gray-600 dark:text-gray-400">Sidecar health, capabilities, and audit trail.</div>
                  </div>

                  <div class="bg-white dark:bg-black p-4 rounded-xl border border-gray-200 dark:border-gray-800 space-y-3">
                    <div>
                      <div class="text-sm font-medium text-black dark:text-white">Service restarts</div>
                      <div class="text-xs text-gray-600 dark:text-gray-400">Restart specific host services without leaving this screen.</div>
                    </div>
                  ...
                  <div class="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
                    <div class="bg-white dark:bg-black p-4 rounded-xl border border-gray-200 dark:border-gray-800 space-y-3">
                      <div>
                        <div class="text-sm font-medium text-black dark:text-white">Versions</div>
                        <div class="text-xs text-gray-600 dark:text-gray-400">Sidecar + desktop build info.</div>
                      </div>
                        <div class="space-y-1">
                          <div class="text-[11px] text-gray-500 dark:text-gray-500 font-mono truncate">Desktop app: {appVersionLabel()}</div>
                          <div class="text-[11px] text-gray-500 dark:text-gray-500 font-mono truncate">Commit: {appCommitLabel()}</div>
                          <div class="text-[11px] text-gray-500 dark:text-gray-500 font-mono truncate">Orchestrator: {orchestratorVersionLabel()}</div>
                          <div class="text-[11px] text-gray-500 dark:text-gray-500 font-mono truncate">OpenCode: {opencodeVersionLabel()}</div>
                          <div class="text-[11px] text-gray-500 dark:text-gray-500 font-mono truncate">
                            OpenWork server: {openworkServerVersionLabel()}
                          </div>
                          <div class="text-[11px] text-gray-500 dark:text-gray-500 font-mono truncate">OpenCodeRouter: {opencodeRouterVersionLabel()}</div>
                        </div>
                    </div>
                    ...
                    <div class="bg-white dark:bg-black p-4 rounded-xl border border-gray-200 dark:border-gray-800 space-y-3">
                      <div class="flex items-center justify-between gap-3">
                        <div>
                          <div class="text-sm font-medium text-black dark:text-white">OpenCode engine</div>
                          <div class="text-xs text-gray-600 dark:text-gray-400">Local execution sidecar.</div>
                        </div>
                      ...
                      <div class="space-y-1">
                        ...
                        <div class="text-[11px] text-gray-500 dark:text-gray-500 font-mono truncate">PID: {props.engineInfo?.pid ?? "—"}</div>
                      </div>
                      <div class="grid gap-2">
                        <div>
                          <div class="text-[11px] text-gray-600 dark:text-gray-400 mb-1">Last stdout</div>
                          <pre class="text-xs text-black dark:text-white whitespace-pre-wrap break-words max-h-24 overflow-auto bg-gray-50 dark:bg-gray-900/50 border border-gray-200 dark:border-gray-800 rounded-lg p-2">
                            {engineStdout()}
                          </pre>
                        </div>
                        <div>
                          <div class="text-[11px] text-gray-600 dark:text-gray-400 mb-1">Last stderr</div>
                          <pre class="text-xs text-black dark:text-white whitespace-pre-wrap break-words max-h-24 overflow-auto bg-gray-50 dark:bg-gray-900/50 border border-gray-200 dark:border-gray-800 rounded-lg p-2">
                            {engineStderr()}
                          </pre>
                        </div>
                    ...
                    <div class="bg-white dark:bg-black p-4 rounded-xl border border-gray-200 dark:border-gray-800 space-y-3">
                      <div class="flex items-center justify-between gap-3">
                        <div>
                          <div class="text-sm font-medium text-black dark:text-white">Orchestrator daemon</div>
                          <div class="text-xs text-gray-600 dark:text-gray-400">Workspace orchestration layer.</div>
                        </div>
                      ...
                      <div class="space-y-1">
                        ...
                        <div class="text-[11px] text-gray-500 dark:text-gray-500 font-mono truncate" title={orchestratorBinaryPath()}>
                      ...
                      <Show when={props.orchestratorStatus?.lastError}>
                        <div>
                          <div class="text-[11px] text-gray-600 dark:text-gray-400 mb-1">Last error</div>
                          <pre class="text-xs text-black dark:text-white whitespace-pre-wrap break-words max-h-24 overflow-auto bg-gray-50 dark:bg-gray-900/50 border border-gray-200 dark:border-gray-800 rounded-lg p-2">
                    ...
                    <div class="bg-white dark:bg-black p-4 rounded-xl border border-gray-200 dark:border-gray-800 space-y-3">
                      <div class="flex items-center justify-between gap-3">
                        <div>
                          <div class="text-sm font-medium text-black dark:text-white">OpenCode SDK</div>
                          <div class="text-xs text-gray-600 dark:text-gray-400">UI connection diagnostics.</div>
                        </div>
                      ...
                      <div class="space-y-1">
                        ...
                        <Show when={props.opencodeConnectStatus?.reason}>
                          <div class="text-[11px] text-gray-500 dark:text-gray-500">Reason: {props.opencodeConnectStatus?.reason}</div>
                        </Show>
                        <Show when={props.opencodeConnectStatus?.metrics}>
                          {(metrics) => (
                            <div class="pt-1 space-y-1 text-[11px] text-gray-500 dark:text-gray-500">
                    ...
                    <div class="bg-white dark:bg-black p-4 rounded-xl border border-gray-200 dark:border-gray-800 space-y-3">
                      <div class="flex items-center justify-between gap-3">
                        <div>
                          <div class="text-sm font-medium text-black dark:text-white">OpenWork server</div>
                          <div class="text-xs text-gray-600 dark:text-gray-400">Config and approvals sidecar.</div>
                        </div>
                      ...
                      <div class="space-y-1">
                        ...
                        <div class="text-[11px] text-gray-500 dark:text-gray-500 font-mono truncate">PID: {props.openworkServerHostInfo?.pid ?? "—"}</div>
                      </div>
                      <div class="grid gap-2">
                        <div>
                          <div class="text-[11px] text-gray-600 dark:text-gray-400 mb-1">Last stdout</div>
                    ...
                    <div class="bg-white dark:bg-black p-4 rounded-xl border border-gray-200 dark:border-gray-800 space-y-3">
                      <div class="flex items-center justify-between gap-3">
                        <div>
                          <div class="text-sm font-medium text-black dark:text-white">OpenCodeRouter sidecar</div>
                          <div class="text-xs text-gray-600 dark:text-gray-400">Messaging bridge service.</div>
                        </div>
                      ...
                      <div class="space-y-1">
                        ...
                        <div class="text-[11px] text-gray-500 dark:text-gray-500 font-mono truncate">PID: {props.opencodeRouterInfo?.pid ?? "—"}</div>
                      </div>
                      <div class="flex items-center gap-2">
                        <Button
                          variant="secondary"
                  ...
                  <div class="bg-white dark:bg-black p-4 rounded-xl border border-gray-200 dark:border-gray-800 space-y-3">
                    <div class="flex items-center justify-between gap-3">
                      <div class="text-sm font-medium text-black dark:text-white">OpenWork server diagnostics</div>
                      <div class="text-[11px] text-gray-500 dark:text-gray-500 font-mono truncate">
                    ...
                    <Show
                      ...
                      fallback={<div class="text-xs text-gray-600 dark:text-gray-400">Diagnostics unavailable.</div>}
                    >
                      {(diag) => (
                        <div class="grid md:grid-cols-2 gap-2 text-xs text-gray-600 dark:text-gray-400">
                  ...
                  <div class="bg-white dark:bg-black p-4 rounded-xl border border-gray-200 dark:border-gray-800 space-y-3">
                    <div class="flex items-center justify-between gap-3">
                      <div class="text-sm font-medium text-black dark:text-white">OpenWork server capabilities</div>
                      <div class="text-[11px] text-gray-500 dark:text-gray-500 font-mono truncate">
                    ...
                    <Show
                      ...
                      fallback={<div class="text-xs text-gray-600 dark:text-gray-400">Capabilities unavailable. Connect with a client token.</div>}
                    >
                      {(caps) => (
                        <div class="grid md:grid-cols-2 gap-2 text-xs text-gray-600 dark:text-gray-400">
                  ...
                  <div class="grid md:grid-cols-2 gap-4">
                    <div class="bg-white dark:bg-black border border-gray-200 dark:border-gray-800 rounded-xl p-4">
                      <div class="text-xs text-gray-600 dark:text-gray-400 mb-2">Pending permissions</div>
                      <pre class="text-xs text-black dark:text-white whitespace-pre-wrap break-words max-h-64 overflow-auto">
                        {props.safeStringify(props.pendingPermissions)}
                      </pre>
                    </div>
                    <div class="bg-white dark:bg-black border border-gray-200 dark:border-gray-800 rounded-xl p-4">
                      <div class="text-xs text-gray-600 dark:text-gray-400 mb-2">Recent events</div>
                      <pre class="text-xs text-black dark:text-white whitespace-pre-wrap break-words max-h-64 overflow-auto">
                  ...
                  <div class="bg-white dark:bg-black border border-gray-200 dark:border-gray-800 rounded-xl p-4">
                    <div class="flex items-center justify-between gap-3 mb-2">
                      <div class="text-xs text-gray-600 dark:text-gray-400">Workspace debug events</div>
                      <Button
                        variant="outline"
                  ...
                  <div class="bg-white dark:bg-black p-4 rounded-xl border border-gray-200 dark:border-gray-800 space-y-3">
                    <div class="flex items-center justify-between gap-3">
                      <div class="text-sm font-medium text-black dark:text-white">Audit log</div>
                    ...
                    <Show
                      ...
                      fallback={<div class="text-xs text-gray-600 dark:text-gray-400">No audit entries yet.</div>}
                    >
                        ...
                        <For each={props.openworkAuditEntries}>
                          {(entry) => (
                            <div class="flex items-start justify-between gap-4 py-2">
                              <div class="min-w-0">
                                <div class="text-sm text-black dark:text-white truncate">{entry.summary}</div>
                                <div class="text-[11px] text-gray-600 dark:text-gray-400 truncate">
                                  {entry.action} · {entry.target} · {formatActor(entry)}
                                </div>
                              </div>
                              <div class="text-[11px] text-gray-600 dark:text-gray-400 whitespace-nowrap">
