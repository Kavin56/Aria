...
function StatusPill(props: { label: string; value: string; ok: boolean }) {
  return (
    <div class="flex-1 rounded-lg border border-gray-200 dark:border-gray-800 bg-white dark:bg-black px-3.5 py-2.5">
      <div class="text-[11px] text-gray-600 dark:text-gray-400 mb-0.5">{props.label}</div>
      <div class={`text-[13px] font-semibold ${props.ok ? "text-black dark:text-white" : "text-gray-500"}`}>{props.value}</div>
    </div>
  );
}
    ...
    <div class="space-y-6 max-w-[680px]">
      ...
      <div>
        <div class="flex items-center justify-between mb-1.5">
          <h1 class="text-lg font-bold text-black dark:text-white tracking-tight">Messaging channels</h1>
        ...
        <div class="mt-1.5 text-[11px] text-gray-500 font-mono break-all">
          Workspace scope: {scopedOpenworkBaseUrl().trim() || props.openworkServerUrl.trim() || "Not set"}
        </div>
        <Show when={reconnectStatus()}>
          {(value) => <div class="mt-1 text-[11px] text-gray-600 dark:text-gray-400">{value()}</div>}
        </Show>
      ...
      <Show when={!serverReady()}>
        <div class="rounded-xl border border-gray-200 dark:border-gray-800 bg-white dark:bg-black p-5">
          <div class="text-sm font-semibold text-black dark:text-white">Connect to an OpenWork server</div>
          <div class="mt-1 text-xs text-gray-600 dark:text-gray-400">
            Identities are available when you are connected to an OpenWork host (<code class="text-[11px] font-mono bg-gray-100 px-1 py-0.5 rounded">openwork</code>).
          </div>
        </div>
      </Show>
      ...
      <Show when={serverReady()}>
        ...
        <div class="flex items-center gap-2 rounded-xl border border-gray-200 dark:border-gray-800 bg-white dark:bg-black p-1">
          <button
            class={`flex-1 rounded-lg px-3 py-2 text-xs font-semibold transition-colors ${
              activeTab() === "general"
                ? "bg-white dark:bg-black2 text-white"
        ...
        {/* ---- Worker status card ---- */}
        <div class="rounded-xl border border-gray-200 dark:border-gray-800 bg-white dark:bg-black p-4 space-y-3.5">
          <div class="flex items-center justify-between">
            <div class="flex items-center gap-2.5">
              ...
              <span class="text-[15px] font-semibold text-black dark:text-white">
        ...
        {/* ---- Available channels ---- */}
        <div>
          <div class="text-[11px] font-semibold text-gray-600 dark:text-gray-400 uppercase tracking-wider mb-3">
            Available channels
          </div>
          ...
          <div class="flex flex-col gap-2.5">
            ...
            >
              ...
              <button
                class="w-full flex items-center gap-3.5 px-4 py-3.5 text-left hover:bg-gray-50 dark:bg-gray-900/50 transition-colors"
                onClick={() => toggleExpand("telegram")}
              >
                <TelegramIcon size={28} />
                <div class="flex-1 min-w-0">
                  <div class="flex items-center gap-2">
                    <span class="text-[15px] font-semibold text-black dark:text-white">Telegram</span>
                  ...
                  <div class="text-[13px] text-gray-600 dark:text-gray-400 mt-0.5 leading-snug">
              ...
              <Show when={expandedChannel() === "telegram"}>
                <div class="border-t border-gray-200 dark:border-gray-800 px-4 py-4 space-y-3 animate-[fadeUp_0.2s_ease-out]">
                  ...
                  <Show when={telegramIdentities().length > 0}>
                    <div class="space-y-2">
                      <For each={telegramIdentities()}>
                        {(item) => (
                          <div class="flex items-center justify-between gap-3 rounded-lg border border-gray-200 dark:border-gray-800 bg-white dark:bg-black px-3 py-2.5">
                            <div class="min-w-0">
                              <div class="flex items-center gap-2">
                                <div class={`w-1.5 h-1.5 rounded-full flex-shrink-0 ${item.running ? "bg-emerald-9" : "bg-gray-8"}`} />
                                <span class="text-[13px] font-semibold text-black dark:text-white truncate">
                                  <span class="font-mono text-[12px]">{item.id}</span>
                                </span>
                              </div>
                              <div class="text-[11px] text-gray-600 dark:text-gray-400 mt-0.5 pl-3.5">
                    ...
                    <div class="flex gap-2.5">
                      <div class="flex-1 rounded-lg border border-gray-200 dark:border-gray-800 bg-gray-50 dark:bg-gray-900/50 px-3 py-2.5">
                        <div class="text-[11px] text-gray-600 dark:text-gray-400 mb-0.5">Status</div>
                        <div class="flex items-center gap-1.5">
                          <div class={`w-1.5 h-1.5 rounded-full ${
                            telegramIdentities().some((i) => i.running) ? "bg-emerald-9" : "bg-gray-8"
                          }`} />
                          <span class={`text-[13px] font-semibold ${
                            telegramIdentities().some((i) => i.running) ? "text-emerald-11" : "text-gray-600 dark:text-gray-400"
                          }`}>
                      ...
                      <div class="flex-1 rounded-lg border border-gray-200 dark:border-gray-800 bg-gray-50 dark:bg-gray-900/50 px-3 py-2.5">
                        <div class="text-[11px] text-gray-600 dark:text-gray-400 mb-0.5">Identities</div>
                        <div class="text-[13px] font-semibold text-black dark:text-white">{telegramIdentities().length} configured</div>
                      </div>
                      <div class="flex-1 rounded-lg border border-gray-200 dark:border-gray-800 bg-gray-50 dark:bg-gray-900/50 px-3 py-2.5">
                        <div class="text-[11px] text-gray-600 dark:text-gray-400 mb-0.5">Channel</div>
                    ...
                    <Show when={telegramStatus()}>
                      {(value) => <div class="text-[11px] text-gray-600 dark:text-gray-400">{value()}</div>}
                    </Show>
                  ...
                  <div class="space-y-2.5">
                    <Show when={telegramIdentities().length === 0}>
                      <div class="rounded-xl border border-gray-200 dark:border-gray-800 bg-gray-50 dark:bg-gray-900/60 px-3.5 py-3 space-y-2.5">
                        <div class="text-[12px] font-semibold text-black dark:text-white">Quick setup</div>
                        <ol class="space-y-2 text-[12px] text-gray-600 dark:text-gray-400 leading-relaxed">
                          <li class="flex items-start gap-2">
                            <span class="mt-0.5 flex h-4 w-4 items-center justify-center rounded-full border-gray-200 dark:border-gray-800 text-[10px] font-semibold text-white1">1</span>
                            <span>
                              Open <a href="https://t.me/BotFather" target="_blank" rel="noreferrer" class="font-medium text-black dark:text-white underline">@BotFather</a> and run <code class="rounded bg-gray-100 px-1 py-0.5 font-mono text-[11px]">/newbot</code>.
                            </span>
                          </li>
                          <li class="flex items-start gap-2">
                            <span class="mt-0.5 flex h-4 w-4 items-center justify-center rounded-full border-gray-200 dark:border-gray-800 text-[10px] font-semibold text-white1">2</span>
                            <span>Copy the bot token and paste it below.</span>
                          </li>
                          <li class="flex items-start gap-2">
                            <span class="mt-0.5 flex h-4 w-4 items-center justify-center rounded-full border-gray-200 dark:border-gray-800 text-[10px] font-semibold text-white1">3</span>
                            <span>Choose <span class="font-medium text-black dark:text-white">Public</span> for open inbox or <span class="font-medium text-black dark:text-white">Private</span> to require <code class="rounded bg-gray-100 px-1 py-0.5 font-mono text-[11px]">/pair &lt;code&gt;</code>.</span>
                          </li>
                        </ol>
                      </div>
                    </Show>
                    ...
                    <div>
                      <label class="text-[12px] text-gray-600 dark:text-gray-400 block mb-1">Bot token</label>
                      <input
                        class="w-full rounded-lg border border-gray-200 dark:border-gray-800 bg-white dark:bg-black px-3 py-2.5 text-sm text-black dark:text-white placeholder:text-gray-500"
                    ...
                    <label class="flex items-center gap-2 text-xs text-white1">
                      <input
                        type="checkbox"
                    ...
                    <div class="rounded-lg border border-gray-200 dark:border-gray-800 bg-gray-50 dark:bg-gray-900/50 px-3 py-2 text-[11px] text-gray-600 dark:text-gray-400 leading-relaxed">
                      ...
                      <button
                        ...
                        class={`flex items-center justify-center gap-2 rounded-lg border px-4 py-2.5 text-sm font-semibold transition-colors ${
                          telegramSaving() || !workspaceId() || !telegramToken().trim()
                            ? "cursor-not-allowed border-gray-5 bg-gray-100 text-gray-500"
                            : "cursor-pointer border-gray-6 bg-white dark:bg-black2 text-white hover:bg-white dark:bg-black1"
                        }`}
                      >
                        <Show
                          when={!telegramSaving()}
                    ...
                    <Show when={telegramBotLink()}>
                      {(value) => (
                        <a
                          ...
                          target="_blank"
                          rel="noreferrer"
                          class="inline-flex items-center gap-2 rounded-lg border border-gray-200 dark:border-gray-800 bg-gray-50 dark:bg-gray-900/50 px-3 py-2 text-[12px] font-medium text-white1 hover:bg-gray-50 dark:bg-gray-900"
                        >
                          <Link size={14} />
            ...
            >
              ...
              >
                ...
                <div class="flex-1 min-w-0">
                  <div class="flex items-center gap-2">
                    <span class="text-[15px] font-semibold text-black dark:text-white">Slack</span>
                ...
                <div class="border-t border-gray-200 dark:border-gray-800 px-4 py-4 space-y-3 animate-[fadeUp_0.2s_ease-out]">
                    ...
                    <div class="flex gap-2.5">
                      <div class="flex-1 rounded-lg border border-gray-200 dark:border-gray-800 bg-gray-50 dark:bg-gray-900/50 px-3 py-2.5">
                        ...
                        <div class="flex items-center gap-1.5">
                          ...
                          <span class={`text-[13px] font-semibold ${
                            slackIdentities().some((i) => i.running) ? "text-emerald-11" : "text-gray-600 dark:text-gray-400"
                          }`}>
                      ...
                      <div class="flex-1 rounded-lg border border-gray-200 dark:border-gray-800 bg-gray-50 dark:bg-gray-900/50 px-3 py-2.5">
                        <div class="text-[11px] text-gray-600 dark:text-gray-400 mb-0.5">Identities</div>
                        <div class="text-[13px] font-semibold text-black dark:text-white">{slackIdentities().length} configured</div>
                      </div>
                      <div class="flex-1 rounded-lg border border-gray-200 dark:border-gray-800 bg-gray-50 dark:bg-gray-900/50 px-3 py-2.5">
                        <div class="text-[11px] text-gray-600 dark:text-gray-400 mb-0.5">Channel</div>
                        <div class="text-[13px] font-semibold text-black dark:text-white">
                  ...
                  <div class="space-y-2.5">
                    ...
                    <div class="space-y-2">
                      ...
                      <div>
                        <label class="text-[12px] text-gray-600 dark:text-gray-400 block mb-1">App token</label>
                        <input
                          class="w-full rounded-lg border border-gray-200 dark:border-gray-800 bg-white dark:bg-black px-3 py-2.5 text-sm text-black dark:text-white placeholder:text-gray-500"
                          placeholder="xapp-..."
                          type="password"
        ...
        {/* ---- Message routing ---- */}
        <div>
          <div class="text-[11px] font-semibold text-gray-600 dark:text-gray-400 uppercase tracking-wider mb-2">
            Message routing
          </div>
          <p class="text-[13px] text-gray-600 dark:text-gray-400 leading-relaxed mb-3">
          ...
          <div class="rounded-xl border border-gray-200 dark:border-gray-800 bg-gray-50 dark:bg-gray-900/50 px-4 py-3.5 space-y-3">
            <div class="flex items-center gap-2">
              <Shield size={16} class="text-gray-600 dark:text-gray-400" />
              <span class="text-[13px] font-medium text-white1">Default routing</span>
            </div>
            <div class="flex items-center gap-2 pl-6">
              <span class="rounded-md border-gray-200 dark:border-gray-800 px-2.5 py-1 text-[12px] font-medium text-white1">
                All channels
              </span>
          ...
          <div class="text-xs text-gray-600 dark:text-gray-400 mt-2.5">
            Advanced: reply with <code class="text-[11px] font-mono bg-gray-100 px-1 py-0.5 rounded">/dir &lt;path&gt;</code> in Slack/Telegram to override the directory for a specific chat (limited to this workspace root).
          </div>
        </div>

        {/* ---- Messaging agent behavior ---- */}
        <div class="rounded-xl border border-gray-200 dark:border-gray-800 bg-white dark:bg-black p-4 space-y-3">
          <div class="flex items-center justify-between gap-2">
            <div>
              <div class="text-[13px] font-semibold text-black dark:text-white">Messaging agent behavior</div>
              <div class="text-[12px] text-gray-600 dark:text-gray-400 mt-0.5">
                One file per workspace. Add optional first line <code class="font-mono">@agent &lt;id&gt;</code> to route via a specific OpenCode agent.
              </div>
            </div>
            <span class="rounded-md border border-gray-200 dark:border-gray-800 bg-gray-50 dark:bg-gray-900/50 px-2 py-1 text-[11px] font-mono text-gray-600 dark:text-gray-400">
          ...
          <Show when={workspaceAgentStatus()}>
            {(value) => (
              <div class="rounded-lg border border-gray-200 dark:border-gray-800 bg-gray-50 dark:bg-gray-900/40 px-3 py-2 text-[11px] text-gray-600 dark:text-gray-400">
          ...
          <Show when={agentLoading()}>
            <div class="text-[11px] text-gray-600 dark:text-gray-400">Loading agent file…</div>
          </Show>
          ...
          <textarea
            class="min-h-[220px] w-full rounded-lg border border-gray-200 dark:border-gray-800 bg-white dark:bg-black px-3 py-2.5 text-[13px] font-mono text-black dark:text-white placeholder:text-gray-500"
          ...
          <div class="flex flex-wrap items-center gap-2">
            ...
            <Show when={agentDirty() && !agentSaving()}>
              <span class="text-[11px] text-gray-600 dark:text-gray-400">Unsaved changes</span>
            </Show>
          </div>
        ...
        <div class="rounded-xl border border-gray-200 dark:border-gray-800 bg-white dark:bg-black p-4 space-y-3">
          <div>
            <div class="text-[13px] font-semibold text-black dark:text-white">Send test message</div>
            <div class="text-[12px] text-gray-600 dark:text-gray-400 mt-0.5">
          ...
          <div class="grid gap-2 sm:grid-cols-2">
            <div>
              <label class="text-[12px] text-gray-600 dark:text-gray-400 block mb-1">Channel</label>
              <select
                class="w-full rounded-lg border border-gray-200 dark:border-gray-800 bg-white dark:bg-black px-3 py-2 text-sm text-black dark:text-white"
                value={sendChannel()}
            ...
            <div>
              <label class="text-[12px] text-gray-600 dark:text-gray-400 block mb-1">Peer ID (optional)</label>
              <input
                class="w-full rounded-lg border border-gray-200 dark:border-gray-800 bg-white dark:bg-black px-3 py-2 text-sm text-black dark:text-white placeholder:text-gray-500"
          ...
          <div class="grid gap-2 sm:grid-cols-2">
            <div>
              <label class="text-[12px] text-gray-600 dark:text-gray-400 block mb-1">Directory (optional)</label>
              <input
                class="w-full rounded-lg border border-gray-200 dark:border-gray-800 bg-white dark:bg-black px-3 py-2 text-sm text-black dark:text-white placeholder:text-gray-500"
          ...
          <div>
            <label class="text-[12px] text-gray-600 dark:text-gray-400 block mb-1">Message</label>
            <textarea
              class="min-h-[90px] w-full rounded-lg border border-gray-200 dark:border-gray-800 bg-white dark:bg-black px-3 py-2 text-sm text-black dark:text-white placeholder:text-gray-500"
          ...
          <div class="flex items-center gap-2">
            ...
            <Show when={sendStatus()}>
              {(value) => <span class="text-[11px] text-gray-600 dark:text-gray-400">{value()}</span>}
            </Show>
          </div>
          ...
          <Show when={sendResult()}>
            {(value) => (
              <div class="rounded-lg border border-gray-200 dark:border-gray-800 bg-gray-50 dark:bg-gray-900/40 px-3 py-2 text-[11px] text-gray-600 dark:text-gray-400 font-mono space-y-1">
                <div>
