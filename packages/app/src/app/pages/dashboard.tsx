...
export default function DashboardView(props: DashboardViewProps) {
  ...
  return (
    <div class="flex h-screen w-full bg-white dark:bg-black text-black dark:text-white font-sans overflow-hidden">
      <aside class="w-64 hidden md:flex flex-col bg-white dark:bg-black border-r border-gray-200 dark:border-gray-800 p-4">
      ...
      <main class="flex-1 flex flex-col overflow-hidden bg-white dark:bg-black">
        <div class="flex-1 overflow-y-auto">
        <header class="h-14 flex items-center justify-between px-6 md:px-10 border-b border-gray-200 dark:border-gray-800 sticky top-0 bg-white dark:bg-black z-10">
          <div class="flex items-center gap-3">
            <Show when={showUpdatePill()}>
              <button
                type="button"
                class={`md:hidden flex items-center gap-1.5 rounded-full border bg-white dark:bg-black px-2.5 py-1 text-xs font-medium shadow-sm transition-colors active:scale-[0.99] focus:outline-none focus-visible:ring-2 focus-visible:ring-[rgba(var(--dls-accent-rgb),0.2)] ${updatePillBorderTone()} ${updatePillButtonTone()}`}
                onClick={handleUpdatePillClick}
                title={updatePillTitle()}
                aria-label={updatePillTitle()}
              >
            ...
            <div class="px-3 py-1.5 rounded-xl bg-gray-50 text-xs text-gray-600 font-medium">
              {props.activeWorkspaceDisplay.name}
            </div>
            <h1 class="text-lg font-medium text-black dark:text-white">{title()}</h1>
            <Show when={props.developerMode}>
              <span class="text-xs text-gray-600">{props.headerStatus}</span>
            </Show>
            <Show when={props.busyHint}>
              <span class="text-xs text-gray-600">{props.busyHint}</span>
            </Show>
          </div>
        ...
        <div class="p-6 md:p-10 max-w-5xl mx-auto space-y-10">
          <Switch>
            ...
            <Match when={props.tab === "mission-control"}>
              <MissionControlView
                workspaceSessionGroups={props.workspaceSessionGroups}
                ...
                refreshPendingPermissions={props.refreshPendingPermissions}
                selectSession={props.selectSession}
                setView={props.setView}
                startHost={props.onStartHost}
                activeWorkspacePath={() => props.activeWorkspaceRoot}
              />
            </Match>
            ...
            <Match when={props.tab === "soul"}>
              <SoulView
                activeWorkspace={props.activeWorkspaceDisplay}
                activeWorkspaceRoot={props.activeWorkspaceRoot}
                jobs={props.scheduledJobs}
                refreshJobs={props.refreshScheduledJobs}
                createSessionAndOpen={props.createSessionAndOpen}
        ...
        <StatusBar
          ...
          mcpStatuses={props.mcpStatuses}
        />
        <nav class="md:hidden border-t border-gray-200 dark:border-gray-800 bg-white dark:bg-black">
          <div class={`mx-auto max-w-5xl px-4 py-3 grid gap-2 ${props.developerMode ? "grid-cols-8" : "grid-cols-7"}`}>
            <button
              class={`flex flex-col items-center gap-1 text-xs ${
                props.tab === "mission-control" ? "text-black dark:text-white" : "text-gray-600 dark:text-gray-400"
              }`}
              onClick={() => props.setTab("mission-control")}
            >
              <Activity size={18} />
              Control
            </button>
            <button
              class={`flex flex-col items-center gap-1 text-xs ${
                props.tab === "soul" ? "text-black dark:text-white" : "text-gray-600 dark:text-gray-400"
              }`}
            ...
            <button
              class={`flex flex-col items-center gap-1 text-xs ${
                props.tab === "scheduled" ? "text-black dark:text-white" : "text-gray-600 dark:text-gray-400"
              }`}
            ...
            <button
              class={`flex flex-col items-center gap-1 text-xs ${
                props.tab === "skills" ? "text-black dark:text-white" : "text-gray-600 dark:text-gray-400"
              }`}
            ...
            <button
              class={`flex flex-col items-center gap-1 text-xs ${
                props.tab === "mcp" || props.tab === "plugins" ? "text-black dark:text-white" : "text-gray-600 dark:text-gray-400"
              }`}
            ...
            <button
              class={`flex flex-col items-center gap-1 text-xs ${
                props.tab === "identities" ? "text-black dark:text-white" : "text-gray-600 dark:text-gray-400"
              }`}
            ...
            <button
              class={`flex flex-col items-center gap-1 text-xs ${
                props.tab === "documents" ? "text-black dark:text-white" : "text-gray-600 dark:text-gray-400"
              }`}
            ...
            <Show when={props.developerMode}>
              <button
              class={`flex flex-col items-center gap-1 text-xs ${
                props.tab === "config" ? "text-black dark:text-white" : "text-gray-600 dark:text-gray-400"
              }`}
      ...
      <aside class="w-56 hidden md:flex flex-col bg-white dark:bg-black border-l border-gray-200 dark:border-gray-800 p-4">
        <div class="space-y-1 pt-2">
          {navItem("mission-control", "Mission Control", <Activity size={18} />)}
          {navItem("soul", "Soul", <Heart size={18} />)}
          ...
          {navItem("documents", "Documentation", <BookOpen size={18} />)}
