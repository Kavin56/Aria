 ...
 * Professional terms (Skills, Plugins, Commands, Sessions, OpenCode, OpenPackage, SHIFT) are NOT translated
 */
...
export default {
  ...
  "dashboard.hero_description": "Describe an outcome. SHIFT will run it and keep an audit trail.",
  ...
  "dashboard.create_remote_workspace_subtitle": "Save an SHIFT server as a worker.",
  "dashboard.create_remote_workspace_confirm": "Add Worker",
  "dashboard.edit_remote_workspace_title": "Edit Remote Connection",
  "dashboard.edit_remote_workspace_subtitle": "Update the SHIFT server details for this worker.",
  "dashboard.edit_remote_workspace_confirm": "Save connection",
  "dashboard.remote_workspace_title": "Remote worker",
  "dashboard.remote_workspace_hint": "Track an SHIFT server and reconnect anytime.",
  "dashboard.remote_base_url_label": "SHIFT server URL",
  "dashboard.remote_base_url_placeholder": "http://127.0.0.1:8787",
  "dashboard.remote_base_url_required": "Add a server URL to continue.",
  "dashboard.openwork_host_label": "SHIFT server URL",
  "dashboard.openwork_host_placeholder": "https://your-server.openwork.app",
  "dashboard.openwork_host_hint": "Use the URL shared by your SHIFT server.",
  ...
  "dashboard.remote_mode_openwork_alpha": "SHIFT server",
  "dashboard.remote_mode_direct": "Direct (legacy)",
  "dashboard.remote_connection_openwork": "SHIFT",
  ...
  "dashboard.folder_mode_local": "Local folder",
  "dashboard.folder_mode_runpod": "Remote path (RunPod)",
  "dashboard.remote_path_placeholder": "e.g. /workspace or /workspace/my-project",
  "dashboard.remote_path_hint": "Enter the folder path on the remote server",
  "dashboard.remote_path_will_use": "Will use:",
  ...
  "skills.host_only_error": "Skill management requires a local worker or connected SHIFT server.",
  ...
  "skills.connect_host_to_load": "Connect an SHIFT server to load skills.",
  ...
  // ==================== Apps (MCP) ====================
  "mcp.apps_title": "Apps",
  "mcp.apps_subtitle": "Connect your favorite tools so SHIFT can use them on your behalf.",
  ...
  "mcp.mcps_title": "Apps",
  "mcp.connect_mcp_hint": "Connect apps to expand what SHIFT can do.",
  ...
  "mcp.mcps_label": "Apps",
  "mcp.mcps_description": "Connect apps to expand what SHIFT can do.",
  ...
  "mcp.login_unavailable": "This app does not support sign-in from SHIFT.",
  ...
  "mcp.auth.reload_notice": "For this to take effect, SHIFT needs to refresh the worker service. This can interrupt a running session.",
  "mcp.auth.reload_blocked": "Reload is paused while a session is running. Stop the run to finish setup.",
  "mcp.auth.reload_remote_confirm": "For this to take effect, SHIFT needs to refresh the worker service. This might stop your running session. Continue?",
  ...
  "mcp.auth.step2_title": "Authorize SHIFT",
  ...
  "settings.updates_description": "Keep SHIFT up to date.",
  ...
  "settings.advanced_description": "Reset SHIFT local state to retest onboarding.",
  "settings.reset_onboarding": "Reset onboarding",
  "settings.reset_onboarding_description": "Clears SHIFT preferences and restarts the app.",
  "settings.reset_app_data": "Reset app data",
  "settings.reset_app_data_description": "More aggressive. Clears SHIFT cache + app data.",
  ...
  "settings.reset_confirmation_hint": "Type <span class=\"font-mono\">RESET</span> to confirm. SHIFT will restart.",
  "settings.reset_onboarding_warning": "Clears SHIFT local preferences and worker onboarding markers.",
  "settings.reset_app_data_warning": "Clears SHIFT cache and app data on this device.",
  ...
  "settings.updates_hint": "Keep SHIFT up to date.",
  ...
  "settings.advanced_hint": "Reset SHIFT local state to retest onboarding.",
  "settings.reset_onboarding_label": "Reset onboarding",
  "settings.reset_onboarding_hint": "Clears SHIFT preferences and restarts the app.",
  "settings.reset_app_data_label": "Reset app data",
  "settings.reset_app_data_hint": "More aggressive. Clears SHIFT cache + app data.",
  ...
  // ==================== Onboarding ====================
  "onboarding.starting_host": "Starting SHIFT server...",
  "onboarding.searching_host": "Connecting to SHIFT server...",
  ...
  "onboarding.windows_install_instruction": "Install OpenCode for Windows, then restart SHIFT. Ensure opencode.exe is on PATH.",
  ...
  "onboarding.cli_install_commands": "Install OpenCode with one of the commands below, then restart SHIFT.",
  ...
  "onboarding.remote_workspace_title": "Connect to SHIFT server",
  "onboarding.remote_workspace_description": "Connect to an SHIFT server to access a worker from anywhere.",
  "onboarding.remote_workspace_action": "Connect",
  "onboarding.remote_workspace_card_title": "Connect a remote worker",
  "onboarding.remote_workspace_card_description": "Connect to an SHIFT server to access a shared worker.",
  "onboarding.advanced_openwork_host": "SHIFT server",
  ...
  "onboarding.welcome_title": "How would you like to run SHIFT today?",
  "onboarding.run_local": "Run locally",
  "onboarding.run_local_description": "SHIFT runs OpenCode locally and keeps your work private.",
  ...
  "onboarding.default_workspace_path": "~/SHIFT/Worker",
  ...
  "app.migration.restart_failed": "Migration completed, but SHIFT could not restart the local engine.",
