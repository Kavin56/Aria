...
export default {
  ...
  "dashboard.folder_mode_local": "本地文件夹",
  "dashboard.folder_mode_runpod": "远程路径 (RunPod)",
  "dashboard.remote_path_placeholder": "例如 /workspace 或 /workspace/my-project",
  "dashboard.remote_path_hint": "输入远程服务器上的文件夹路径",
  "dashboard.remote_path_will_use": "将使用：",
